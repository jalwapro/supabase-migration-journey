...
function LiveRoomsStudioRoute() {
  ...
  async function saveDraft() {
    ...
    if (findError) { toast.error(findError.message); setSaving(false); return; }
    ...
    setSaving(false);
    if (result.error) toast.error(result.error.message); else toast.success(`${page.name} draft saved`);
  }
