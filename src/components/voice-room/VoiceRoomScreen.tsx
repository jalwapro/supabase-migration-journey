...
export const VoiceRoomScreen = ({
  ...
  const visibleMessages = roomMessages.filter(m => m.kind !== "emoji").slice(-6);
  ...
  return (
    <main className="fixed inset-0 z-50 mx-auto flex w-full max-w-[480px] flex-col overflow-hidden bg-background text-foreground shadow-2xl h-[100svh]">
      ...
      {showRocketAnimation && (
        <div className="absolute inset-0 z-50 pointer-events-none flex items
