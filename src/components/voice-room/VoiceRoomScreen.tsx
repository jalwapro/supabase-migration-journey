  ...
  return (
    <main className="relative z-50 mx-auto flex h-[100dvh] w-full max-w-[480px] flex-col overflow-hidden bg-background text-foreground shadow-2xl">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-hidden bg-transparent">
        ...
        {/* Main layout container with fixed boundaries so seats and chat never collide */}
        <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden pb-1">
          {/* SeatGrid is locked as a top block, keeping capacity height contained */}
          ...
          {/* Chat and slide section takes exact remaining vertical space without expanding past the 20 seats grid boundary */}
          <section className="mt-auto grid h-[130px] shrink-0 grid-cols-[minmax(0,1.7fr)_minmax(75px,.7fr)] gap-1.5 px-2 py-1">
