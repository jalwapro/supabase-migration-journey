...
export interface StudioAsset { id: string; name: string; kind: AssetKind; type?: AssetKind; url: string; mimeType?: string; sizeBytes?: number; width?: number; height?: number; category?: string; metadata?: Record<string, unknown>; createdAt?: string; }
