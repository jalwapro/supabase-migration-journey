-- 0311: every room entry creates an entrance event.
-- Equipped entrance => event carries the selected media/video.
-- No equipped entrance => event carries only identity data so the room can
-- still show the normal slow entrance slide above chat.
