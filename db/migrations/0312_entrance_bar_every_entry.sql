-- 0312: Always create a room entrance event so every room entry shows the slim entrance bar.
-- Users without an equipped visual effect previously returned `no_effect`, so no
-- room_entrances row was created and other clients had nothing to render.
