-- Allow the host to choose any whole-number voice-room capacity from 4 through 20.
-- Seat 1 remains reserved for the host; participant seats are 2..capacity.
-- This supersedes the earlier 4/8/12/16/20-only RPC.
...
begin
  ...
  if _seat_count is null or _seat_count < 4 or _seat_count > 20 or _seat_count <> trunc(_seat_count) then
    raise exception 'seat count must be a whole number between 4 and 20';
  end if;
